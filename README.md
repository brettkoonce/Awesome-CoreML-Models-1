...
* **MNIST-Keras** - Build model and predict handwritten (drawn) digits from images. [Download](https://github.com/asparagui/keras_mnist_demo/blob/master/keras_mnist_demo/mnist_model.mlmodel?raw=true) | [Demo](https://github.com/asparagui/keras_mnist_demo) | [Reference](https://academy.realm.io/posts/brett-koonce-cnns-swift-metal-swift-language-user-group-2017/)
